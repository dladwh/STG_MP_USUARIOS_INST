...
--  Created Date                : Tue Sep 30 16:03:51 GMT-03:00 2014
--  Modified Date               : Tue Sep 30 16:03:51 GMT-03:00 2014
--  Created By                  : owb11204_idesa
--  Modified By                 : owb11204_idesa
--  Generated Object Type       : PL/SQL Package
--  Generated Object Name       : "APP_STG_MP_USUARIOS_INST"
--  Comments                    : 
*****************************************************************************/
...
BEGIN
  ...
  sql_stmt := 'SELECT TABLE_NAME FROM OWB$TEMP_TABLES WHERE PACKAGE_NAME = ''APP_STG_MP_USUARIOS_INST''';
  ...
  END LOOP;
  CLOSE c1;
  EXECUTE IMMEDIATE 'DELETE FROM OWB$TEMP_TABLES WHERE PACKAGE_NAME = ''APP_STG_MP_USUARIOS_INST''';
  COMMIT;
EXCEPTION WHEN OTHERS THEN
  DBMS_OUTPUT.PUT_LINE(SQLERRM);
END;  
...
END;
/
CREATE OR REPLACE PACKAGE "APP_STG_MP_USUARIOS_INST"  AS

-- Map Generation Timestamp
get_generation_date      VARCHAR2(100) := 'Tue Sep 30 16:03:51 GMT-03:00 2014';
...
get_lob_uoid                  CONSTANT VARCHAR2(40) := '043B5FA4CC4441AAE053B200090A2A1E';
get_model_name                CONSTANT VARCHAR2(40) := '"APP_STG_MP_USUARIOS_INST"';
...
"STG_MP_USUARIOS_INST_St" Boolean;
...
-- Function Main -- Entry point in package "APP_STG_MP_USUARIOS_INST"
--------------------------------------------------
-- Function Main: Should only be called by OWB. --
--------------------------------------------------

FUNCTION Main("COD_FECHA" IN NUMBER
 DEFAULT NULL,
...
-------------------------------------------------
PROCEDURE Main(p_status OUT VARCHAR2,               "COD_FECHA" IN NUMBER
 DEFAULT NULL,
"CANT_FILAS" IN NUMBER
 DEFAULT NULL,
"COD_FECHA_DIARIO" IN NUMBER
...
END "APP_STG_MP_USUARIOS_INST";


/

CREATE OR REPLACE PACKAGE BODY "APP_STG_MP_USUARIOS_INST" AS

-- Define cursors here so that they have global scope within the package (for debugger)

---------------------------------------------------------------------------
--
-- "EXT_MP_USUARIOS_INST_c" Cursor declaration 
--
---------------------------------------------------------------------------
CURSOR "EXT_MP_USUARIOS_INST_c" IS
 SELECT
/* EXT_MP_USUARIOS_INST.OUTGRP1 */
  "EXT_MP_USUARIOS_INST"."ID_CLIENTE" "ID_CLIENTE",
  "EXT_MP_USUARIOS_INST"."FECHA_LOGIN" "FECHA_LOGIN"
FROM
  "EXT_MP_USUARIOS_INST"  "EXT_MP_USUARIOS_INST"; 

---------------------------------------------------------------------------
--
-- "EXT_MP_USUARIOS_INST_c$1" Cursor declaration 
--
---------------------------------------------------------------------------
CURSOR "EXT_MP_USUARIOS_INST_c$1" IS
 SELECT
/* EXT_MP_USUARIOS_INST.OUTGRP1 */
  "EXT_MP_USUARIOS_INST"."ID_CLIENTE" "ID_CLIENTE",
  "EXT_MP_USUARIOS_INST"."FECHA_LOGIN" "FECHA_LOGIN"
...
"STG_MP_USUARIOS_IN_tt_sqlcode"  NUMBER := NULL;
"STG_MP_USUARIOS_IN_tt_sqlerrm"  VARCHAR2(2000) := NULL;
...
---------------------------------------------------------------------------
-- Function "STG_MP_USUARIOS_INST_Bat"
...
BEGIN
  ...
  get_abort_procedure := FALSE;
    ...
    batch_auditd_id := OWBSYS.WB_RT_MAPAUDIT.auditd_begin(  -- Template BatchAuditDetailBegin
      ...
      p_step=>0,
      p_name=>'"STG_MP_USUARIOS_INST_Bat"',
      p_source=>'*',
      p_source_uoid=>'*',
      p_target=>'"STG_MP_USUARIOS_INST"',
      p_target_uoid=>'043B5FA4CC1041AAE053B200090A2A1E',
    ...
    p_parent_operator_uoid=>'043B5FA4CC1041AAE053B200090A2A1E', -- Operator STG_MP_USUARIOS_INST
    p_parent_object_name=>'STG_MP_USUARIOS_INST',
    p_parent_object_uoid=>'043B5FA4CA8041AAE053B200090A2A1E', -- Tabla STG_MP_USUARIOS_INST
    p_parent_object_type=>'Tabla',
    p_object_name=>'STG_MP_USUARIOS_INST',
    p_object_uoid=>'043B5FA4CA8041AAE053B200090A2A1E', -- Tabla STG_MP_USUARIOS_INST
    p_object_type=>'Tabla',
    p_location_uoid=>'03C05C514D115B62E053B200090A5929' -- Location DW_STG_LOCATION1
  );
    	get_audit_detail_type_id := OWBSYS.WB_RT_MAPAUDIT.register_audit_detail_type(
    p_rtd=>get_audit_detail_id,
    p_parent_operator_uoid=>'043B5FA4CC2541AAE053B200090A2A1E', -- Operator EXT_MP_USUARIOS_INST
    p_parent_object_name=>'EXT_MP_USUARIOS_INST',
    p_parent_object_uoid=>'043B5FA4CB7641AAE053B200090A2A1E', -- Tabla Externa EXT_MP_USUARIOS_INST
    p_parent_object_type=>'Tabla Externa',
    p_object_name=>'EXT_MP_USUARIOS_INST',
    p_object_uoid=>'043B5FA4CB7641AAE053B200090A2A1E', -- Tabla Externa EXT_MP_USUARIOS_INST
  ...
  BEGIN
    ...
    IF NOT "STG_MP_USUARIOS_INST_St" THEN
      IF get_use_hc THEN
        IF "STG_MP_USUARIOS_IN_tt_sqlcode" IS NOT NULL THEN
          RAISE_APPLICATION_ERROR(-20016, "STG_MP_USUARIOS_IN_tt_sqlerrm");
        END IF;
      ELSE
        -- Truncate the target table
        EXECUTE IMMEDIATE 'TRUNCATE TABLE "STG_MP_USUARIOS_INST"';
      END IF;
    END IF;
    ...
    IF NOT "STG_MP_USUARIOS_INST_St" THEN
      ...
      INSERT
      INTO
        "STG_MP_USUARIOS_INST"  "STG_MP_USUARIOS_INST"
        ("ID_CLIENTE",
        "COD_FECHA_LOGIN",
        "COD_FECHA_DIARIO",
        "COD_FECHA")
...
/* EXT_MP_USUARIOS_INST.OUTGRP1 */
  "EXT_MP_USUARIOS_INST"."ID_CLIENTE" "ID_CLIENTE",
  "EXT_MP_USUARIOS_INST"."FECHA_LOGIN" "FECHA_LOGIN",
  "APP_STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"/* ATTRIBUTE P_COD_FECHA_DIARIO.OUTGRP1.COD_FECHA_DIARIO */ "COD_FECHA_DIARIO$1",
  "APP_STG_MP_USUARIOS_INST"."COD_FECHA"/* ATTRIBUTE P_COD_FECHA.OUTGRP1.COD_FECHA */ "COD_FECHA$1"
FROM
  "EXT_MP_USUARIOS_INST"  "EXT_MP_USUARIOS_INST"
        )
      ;
  ...
  END IF;
  RETURN TRUE;
END "STG_MP_USUARIOS_INST_Bat";



-- Procedure "EXT_MP_USUARIOS_INST_p" is the entry point for map "EXT_MP_USUARIOS_INST_p"

PROCEDURE "EXT_MP_USUARIOS_INST_p"
("COD_FECHA" IN NUMBER
 DEFAULT NULL,
"CANT_FILAS" IN NUMBER
 DEFAULT NULL,
...
get_map_name               CONSTANT VARCHAR2(40) := '"EXT_MP_USUARIOS_INST_p"';
get_source_name            CONSTANT VARCHAR2(2000) := SUBSTRB('"EXT_MP_USUARIOS_INST"',0,2000);
get_source_uoid            CONSTANT VARCHAR2(2000) := SUBSTRB('043B5FA4CC2541AAE053B200090A2A1E',0,2000);
...
"STG_MP_USUARIOS_INST_id" NUMBER(22) := 0;
"STG_MP_USUARIOS_INST_ins" NUMBER(22) := 0;
"STG_MP_USUARIOS_INST_upd" NUMBER(22) := 0;
"STG_MP_USUARIOS_INST_del" NUMBER(22) := 0;
"STG_MP_USUARIOS_INST_err" NUMBER(22) := 0;
...
"STG_MP_USUARIOS_INST_srk" OWBSYS.WB_RT_MAPAUDIT.NUMBERLIST;
...
"STG_MP_USUARIOS_INST_ir"  index_redirect_array;
"SV_STG_MP_USUARIOS_INST_srk" NUMBER;
"STG_MP_USUARIOS_INST_new"  BOOLEAN;
"STG_MP_USUARIOS_INST_nul"  BOOLEAN := FALSE;
...
"EXT_MP_USUARIOS_INST_si" NUMBER(22) := 0;

"EXT_MP_USUARIOS_INST_i" NUMBER(22) := 0;


"STG_MP_USUARIOS_INST_si" NUMBER(22) := 0;

"STG_MP_USUARIOS_INST_i" NUMBER(22) := 0;
...
TYPE "T_ROWKEY_EXT_MP_USUARIOS_INST" IS TABLE OF VARCHAR2(18) INDEX BY BINARY_INTEGER;
TYPE "T_EXT_MP_U_2_FECHA_LO" IS TABLE OF NUMBER(12) INDEX BY BINARY_INTEGER;
TYPE "T_STG_MP_U_0_ID_CLIEN" IS TABLE OF NUMBER(10) INDEX BY BINARY_INTEGER;
TYPE "T_STG_MP_U_1_COD_FECH" IS TABLE OF NUMBER(12) INDEX BY BINARY_INTEGER;
TYPE "T_STG_MP_U_2_COD_FECH" IS TABLE OF NUMBER(8) INDEX BY BINARY_INTEGER;
...
"SV_ROWKEY_EXT_MP_USUARIOS_INST"  VARCHAR2(18);
"SV_EXT_MP_U_2_FECHA_LO"  NUMBER(12);
"SV_STG_MP_U_0_ID_CLIEN"  NUMBER(10);
"SV_STG_MP_U_1_COD_FECH"  NUMBER(12);
"SV_STG_MP_U_2_COD_FECH"  NUMBER(8);
"SV_STG_MP_U_3_COD_FECH"  NUMBER(8);

-- Bulk: intermediate collection variables
"EXT_MP_U_1_ID_CLIEN" "T_EXT_MP_U_1_ID_CLIEN";
"ROWKEY_EXT_MP_USUARIOS_INST" "T_ROWKEY_EXT_MP_USUARIOS_INST";
"EXT_MP_U_2_FECHA_LO" "T_EXT_MP_U_2_FECHA_LO";
"STG_MP_U_0_ID_CLIEN" "T_STG_MP_U_0_ID_CLIEN";
"STG_MP_U_1_COD_FECH" "T_STG_MP_U_1_COD_FECH";
"STG_MP_U_2_COD_FECH" "T_STG_MP_U_2_COD_FECH";
...
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_ES"(error_index IN NUMBER) IS
BEGIN
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_seq=>1,
    p_instance=>1,
    p_table=>SUBSTR('"EXT_MP_USUARIOS_INST"',0,80),
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_instance=>1,
    p_table=>SUBSTR('"EXT_MP_USUARIOS_INST"',0,80),
    p_column=>SUBSTR('FECHA_LOGIN',0,80),
    p_value=>SUBSTRB("EXT_MP_U_2_FECHA_LO"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  RETURN;
    
  END "EXT_MP_USUARIOS_INST_ES";

---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_ER" registers error for one erroneous row
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_ER"(p_statement IN VARCHAR2, p_column IN VARCHAR2, p_col_value IN VARCHAR2, p_sqlcode IN NUMBER, p_sqlerrm IN VARCHAR2, p_auditd_id IN NUMBER, p_error_index IN NUMBER) IS
...
END IF;
  ...
  IF ( get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE ) AND (get_rowkey_error > 0) THEN
    "EXT_MP_USUARIOS_INST_ES"(p_error_index);
  END IF;
END "EXT_MP_USUARIOS_INST_ER";



---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_SU" opens and initializes data source
-- for map "EXT_MP_USUARIOS_INST_p"
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_SU" IS
BEGIN
  IF get_abort THEN
    RETURN;
  END IF;
  IF (NOT "EXT_MP_USUARIOS_INST_c"%ISOPEN) THEN
    OPEN "EXT_MP_USUARIOS_INST_c";
  END IF;
  get_read_success := TRUE;
END "EXT_MP_USUARIOS_INST_SU";

---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_RD" fetches a bulk of rows from
--   the data source for map "EXT_MP_USUARIOS_INST_p"
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_RD" IS
BEGIN
  ...
  BEGIN
    ...
    "EXT_MP_U_2_FECHA_LO".DELETE;

    FETCH
      "EXT_MP_USUARIOS_INST_c"
    BULK COLLECT INTO
      "EXT_MP_U_1_ID_CLIEN",
      "EXT_MP_U_2_FECHA_LO"
    LIMIT get_bulk_size;
    ...
    IF "EXT_MP_USUARIOS_INST_c"%NOTFOUND AND "EXT_MP_U_1_ID_CLIEN".COUNT = 0 THEN
      RETURN;
    END IF;
  ...
  END;
END "EXT_MP_USUARIOS_INST_RD";

---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_DML" does DML for a bulk of rows starting from index si.
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_DML"(si NUMBER, firstround BOOLEAN) IS
 "STG_MP_USUARIOS_INST_ins0" NUMBER := "STG_MP_USUARIOS_INST_ins";
BEGIN
 IF get_use_hc THEN
  ...
  get_row_status := TRUE;
 END IF;
 IF NOT "STG_MP_USUARIOS_INST_St" AND (NOT get_use_hc OR get_row_status) 
AND (NOT (get_use_hc AND "STG_MP_USUARIOS_INST_nul")) THEN
  -- Insert DML for "STG_MP_USUARIOS_INST"
  normal_action := 'INSERT';
  error_action  := 'INSERT';
  get_target_name := '"STG_MP_USUARIOS_INST"';
  get_audit_detail_id := "STG_MP_USUARIOS_INST_id";
  IF get_use_hc AND NOT firstround THEN
    "STG_MP_USUARIOS_INST_si" := "STG_MP_USUARIOS_INST_ir"(si);
    IF "STG_MP_USUARIOS_INST_si" = 0 THEN
      "STG_MP_USUARIOS_INST_i" := 0;
    ELSE
      "STG_MP_USUARIOS_INST_i" := "STG_MP_USUARIOS_INST_si" + 1;
    END IF;
  ELSE
    "STG_MP_USUARIOS_INST_si" := 1;
  END IF;
  LOOP
    IF NOT get_use_hc THEN
    EXIT WHEN "STG_MP_USUARIOS_INST_i" <= get_bulk_size 
 AND "EXT_MP_USUARIOS_INST_c"%FOUND AND NOT get_abort;
    ELSE
      EXIT WHEN "STG_MP_USUARIOS_INST_si" >= "STG_MP_USUARIOS_INST_i";
    END IF;
    get_rowid.DELETE;

    BEGIN
      FORALL i IN "STG_MP_USUARIOS_INST_si".."STG_MP_USUARIOS_INST_i" - 1
        INSERT 
        INTO
          "STG_MP_USUARIOS_INST"
          ("STG_MP_USUARIOS_INST"."ID_CLIENTE",
          "STG_MP_USUARIOS_INST"."COD_FECHA_LOGIN",
          "STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO",
          "STG_MP_USUARIOS_INST"."COD_FECHA"
          )
        VALUES
          ("STG_MP_U_0_ID_CLIEN"(i),
          "STG_MP_U_1_COD_FECH"(i),
          "STG_MP_U_2_COD_FECH"(i),
          "STG_MP_U_3_COD_FECH"(i)
          )
        RETURNING ROWID BULK COLLECT INTO get_rowid;
      error_index := "STG_MP_USUARIOS_INST_si" + get_rowid.COUNT;
    EXCEPTION
      WHEN OTHERS THEN
          last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
        ...
        error_index := "STG_MP_USUARIOS_INST_si" + get_rowid.COUNT;
        IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
          error_rowkey := "STG_MP_USUARIOS_INST_srk"(error_index);
          OWBSYS.WB_RT_MAPAUDIT.error(
            p_rta=>get_runtime_audit_id,
            p_step=>get_step_number,
            p_rtd=>get_audit_detail_id,
          ...
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."ID_CLIENTE"',0,80),SUBSTRB("STG_MP_U_0_ID_CLIEN"(error_index),0,2000));
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."COD_FECHA_LOGIN"',0,80),SUBSTRB("STG_MP_U_1_COD_FECH"(error_index),0,2000));
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"',0,80),SUBSTRB("STG_MP_U_2_COD_FECH"(error_index),0,2000));
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."COD_FECHA"',0,80),SUBSTRB("STG_MP_U_3_COD_FECH"(error_index),0,2000));
        ...
        END IF; 
        "STG_MP_USUARIOS_INST_err" := "STG_MP_USUARIOS_INST_err" + 1;
        
        IF get_errors + "STG_MP_USUARIOS_INST_err" > get_max_errors THEN
          get_abort:= TRUE;
        END IF;
    END;
    ...
    IF get_audit_level = AUDIT_COMPLETE THEN
      ...
      rowkey_bulk_index := 1;
      FOR rowkey_index IN "STG_MP_USUARIOS_INST_si"..error_index - 1 LOOP
        get_rowkey_bulk(rowkey_bulk_index) := "STG_MP_USUARIOS_INST_srk"(rowkey_index);
...
END IF;
    ...
    "STG_MP_USUARIOS_INST_ins" := "STG_MP_USUARIOS_INST_ins" + get_rowid.COUNT;
    "STG_MP_USUARIOS_INST_si" := error_index + 1;

    IF "STG_MP_USUARIOS_INST_si" >= "STG_MP_USUARIOS_INST_i" OR get_abort THEN
      "STG_MP_USUARIOS_INST_i" := 1;
      EXIT;
    END IF;
  END LOOP;
END IF;
...
END IF;
 ...
 "STG_MP_USUARIOS_INST_ins" := "STG_MP_USUARIOS_INST_ins0";
END IF;

END "EXT_MP_USUARIOS_INST_DML";

---------------------------------------------------------------------------
-- "EXT_MP_USUARIOS_INST_p" main
---------------------------------------------------------------------------
...
END IF;
  ...
  IF NOT "STG_MP_USUARIOS_INST_St" THEN
    ...
    IF get_table_function OR (NOT "EXT_MP_USUARIOS_INST_c"%ISOPEN) THEN
      IF NOT (get_audit_level = AUDIT_NONE) THEN
        IF NOT "STG_MP_USUARIOS_INST_St" THEN
          "STG_MP_USUARIOS_INST_id" :=
...
END IF;
    ...
    "EXT_MP_USUARIOS_INST_si" := 0;
    "STG_MP_USUARIOS_INST_i" := 1;
    get_rows_processed := FALSE;

    IF NOT get_abort AND NOT get_abort_procedure THEN
      "EXT_MP_USUARIOS_INST_SU";

      LOOP
        IF "EXT_MP_USUARIOS_INST_si" = 0 THEN
          "EXT_MP_USUARIOS_INST_RD";   -- Fetch data from source
          IF NOT get_read_success THEN
          ...
          IF get_use_hc THEN
            dml_bsize := 0;
            "STG_MP_USUARIOS_INST_ir".DELETE;
"STG_MP_USUARIOS_INST_i" := 1;
          END IF;
        END IF;

        -- Processing:
        "EXT_MP_USUARIOS_INST_i" := "EXT_MP_USUARIOS_INST_si";
        BEGIN
          
          LOOP
            EXIT WHEN "STG_MP_USUARIOS_INST_i" > get_bulk_size OR get_abort OR get_abort_procedure;

            "EXT_MP_USUARIOS_INST_i" := "EXT_MP_USUARIOS_INST_i" + 1;
            "EXT_MP_USUARIOS_INST_si" := "EXT_MP_USUARIOS_INST_i";
            IF get_use_hc THEN
              get_row_status := TRUE;
                "STG_MP_USUARIOS_INST_new" := FALSE;
            END IF;

            get_buffer_done(get_buffer_done_index) := 
              ("EXT_MP_USUARIOS_INST_c"%NOTFOUND AND
               "EXT_MP_USUARIOS_INST_i" > bulk_count);

            IF (NOT get_buffer_done(get_buffer_done_index)) AND
              "EXT_MP_USUARIOS_INST_i" > bulk_count THEN
...
get_target_name := '"STG_MP_USUARIOS_INST"';
            get_audit_detail_id := "STG_MP_USUARIOS_INST_id";
            IF NOT "STG_MP_USUARIOS_INST_St" AND NOT get_buffer_done(get_buffer_done_index) THEN
              BEGIN
                get_rows_processed := true; -- Set to indicate that some row data was processed (for debugger)
            		error_stmt := SUBSTRB('"STG_MP_U_0_ID_CLIEN"("STG_MP_USUARIOS_INST_i") := 
            
            "EXT_MP_U_1_ID_CLIEN"("EXT_MP_USUARIOS_INST_i");',0,2000);
            error_column := SUBSTRB('"STG_MP_U_0_ID_CLIEN"',0,80);
            
            BEGIN
              error_value := SUBSTRB("EXT_MP_U_1_ID_CLIEN"("EXT_MP_USUARIOS_INST_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_0_ID_CLIEN"("STG_MP_USUARIOS_INST_i") :=
            
            "EXT_MP_U_1_ID_CLIEN"("EXT_MP_USUARIOS_INST_i");
            ...
            END IF;
            		...
            		error_stmt := SUBSTRB('"STG_MP_U_1_COD_FECH"("STG_MP_USUARIOS_INST_i") := 
            
            "EXT_MP_U_2_FECHA_LO"("EXT_MP_USUARIOS_INST_i");',0,2000);
            error_column := SUBSTRB('"STG_MP_U_1_COD_FECH"',0,80);
            
            BEGIN
              error_value := SUBSTRB("EXT_MP_U_2_FECHA_LO"("EXT_MP_USUARIOS_INST_i"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_1_COD_FECH"("STG_MP_USUARIOS_INST_i") :=
            
            "EXT_MP_U_2_FECHA_LO"("EXT_MP_USUARIOS_INST_i");
            
            ELSIF get_row_status THEN
              "SV_STG_MP_U_1_COD_FECH" :=
            ...
            END IF;
            		...
            		error_stmt := SUBSTRB('"STG_MP_U_2_COD_FECH"("STG_MP_USUARIOS_INST_i") := 
            
            "APP_STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"/* ATTRIBUTE P_COD_FECHA_DIARIO.OUTGRP1.COD_FECHA_DIARIO */;',0,2000);
            error_column := SUBSTRB('"STG_MP_U_2_COD_FECH"',0,80);
            
            BEGIN
              error_value := SUBSTRB("APP_STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"/* ATTRIBUTE P_COD_FECHA_DIARIO.OUTGRP1.COD_FECHA_DIARIO */,0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_2_COD_FECH"("STG_MP_USUARIOS_INST_i") :=
            
            "APP_STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"/* ATTRIBUTE P_COD_FECHA_DIARIO.OUTGRP1.COD_FECHA_DIARIO */;
            
            ELSIF get_row_status THEN
              "SV_STG_MP_U_2_COD_FECH" :=
            ...
            END IF;
            		...
            		error_stmt := SUBSTRB('"STG_MP_U_3_COD_FECH"("STG_MP_USUARIOS_INST_i") := 
            
            "APP_STG_MP_USUARIOS_INST"."COD_FECHA"/* ATTRIBUTE P_COD_FECHA.OUTGRP1.COD_FECHA */;',0,2000);
            error_column := SUBSTRB('"STG_MP_U_3_COD_FECH"',0,80);
            
            BEGIN
              error_value := SUBSTRB("APP_STG_MP_USUARIOS_INST"."COD_FECHA"/* ATTRIBUTE P_COD_FECHA.OUTGRP1.COD_FECHA */,0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_3_COD_FECH"("STG_MP_USUARIOS_INST_i") :=
            
            "APP_STG_MP_USUARIOS_INST"."COD_FECHA"/* ATTRIBUTE P_COD_FECHA.OUTGRP1.COD_FECHA */;
            ...
            END IF;
                ...
                IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
                  IF NOT get_use_hc THEN
                    "STG_MP_USUARIOS_INST_srk"("STG_MP_USUARIOS_INST_i") := get_rowkey + "EXT_MP_USUARIOS_INST_i" - 1;
                  ELSIF get_row_status THEN
                    "SV_STG_MP_USUARIOS_INST_srk" := get_rowkey + "EXT_MP_USUARIOS_INST_i" - 1;
                  ELSE
                    NULL;
                  END IF;
                  END IF;
                  IF get_use_hc THEN
                  "STG_MP_USUARIOS_INST_new" := TRUE;
                ELSE
                  "STG_MP_USUARIOS_INST_i" := "STG_MP_USUARIOS_INST_i" + 1;
                END IF;
              EXCEPTION
                WHEN OTHERS THEN
                    last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
                  ...
                  "EXT_MP_USUARIOS_INST_ER"('TRACE 22: ' || error_stmt, error_column, error_value, SQLCODE, SQLERRM, get_audit_detail_id, "EXT_MP_USUARIOS_INST_i");
            ...
            IF get_use_hc AND get_row_status AND ("STG_MP_USUARIOS_INST_new") THEN
              dml_bsize := dml_bsize + 1;
            	IF "STG_MP_USUARIOS_INST_new" 
            AND (NOT "STG_MP_USUARIOS_INST_nul") THEN
              "STG_MP_USUARIOS_INST_ir"(dml_bsize) := "STG_MP_USUARIOS_INST_i";
            	"STG_MP_U_0_ID_CLIEN"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_0_ID_CLIEN";
            	"STG_MP_U_1_COD_FECH"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_1_COD_FECH";
            	"STG_MP_U_2_COD_FECH"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_2_COD_FECH";
            	"STG_MP_U_3_COD_FECH"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_3_COD_FECH";
              "STG_MP_USUARIOS_INST_srk"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_USUARIOS_INST_srk";
              "STG_MP_USUARIOS_INST_i" := "STG_MP_USUARIOS_INST_i" + 1;
            ELSE
              "STG_MP_USUARIOS_INST_ir"(dml_bsize) := 0;
            END IF;
            END IF;
            
          END LOOP;

          "EXT_MP_USUARIOS_INST_DML"(1, TRUE);
          IF get_use_hc THEN
            IF NOT get_row_status THEN
              FOR start_index IN 1..dml_bsize LOOP
                "EXT_MP_USUARIOS_INST_DML"(start_index, FALSE);
              END LOOP;
            ELSE
              COMMIT;
            END IF;
        ...
        EXCEPTION
          WHEN OTHERS THEN
              last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
            "EXT_MP_USUARIOS_INST_ER"('TRACE 19: ' || error_stmt, '*', NULL, SQLCODE, SQLERRM, NULL, "EXT_MP_USUARIOS_INST_i");
            get_errors := get_errors + 1;
...
END IF;
  ...
  IF NOT "STG_MP_USUARIOS_INST_St" AND bulk_commit_count > get_commit_frequency THEN
            IF NOT (get_audit_level = AUDIT_NONE) THEN
              OWBSYS.WB_RT_MAPAUDIT.auditd_progress(
                p_rtd=>"STG_MP_USUARIOS_INST_id",
                p_sel=>get_map_selected,
                p_ins=>"STG_MP_USUARIOS_INST_ins",
                p_upd=>"STG_MP_USUARIOS_INST_upd",
                p_del=>"STG_MP_USUARIOS_INST_del",
                p_err=>"STG_MP_USUARIOS_INST_err",
                p_dis=>NULL
              );
            END IF;
            IF NOT get_no_commit THEN
        ...
        cursor_exhausted := "EXT_MP_USUARIOS_INST_c"%NOTFOUND;
        exit_loop_normal := get_abort OR get_abort_procedure OR (cursor_exhausted AND "EXT_MP_USUARIOS_INST_i" > bulk_count);
        exit_loop_early := get_rows_processed AND get_bulk_loop_count IS NOT NULL AND "EXT_MP_USUARIOS_INST_i" >= get_bulk_loop_count;
  ...
  IF NOT "STG_MP_USUARIOS_INST_St"
    ...
    END IF;
  	get_inserted := get_inserted + "STG_MP_USUARIOS_INST_ins";
    get_updated  := get_updated  + "STG_MP_USUARIOS_INST_upd";
    get_deleted  := get_deleted  + "STG_MP_USUARIOS_INST_del";
    get_errors   := get_errors   + "STG_MP_USUARIOS_INST_err";
...
END "EXT_MP_USUARIOS_INST_p";



-- Procedure "EXT_MP_USUARIOS_INST_t" is the entry point for map "EXT_MP_USUARIOS_INST_t"

PROCEDURE "EXT_MP_USUARIOS_INST_t"
("COD_FECHA" IN NUMBER
 DEFAULT NULL,
"CANT_FILAS" IN NUMBER
 DEFAULT NULL,
...
"TABLE_NAME" IN VARCHAR2
 DEFAULT NULL) IS
-- Constants for this map
get_map_name               CONSTANT VARCHAR2(40) := '"EXT_MP_USUARIOS_INST_t"';
get_source_name            CONSTANT VARCHAR2(2000) := SUBSTRB('"EXT_MP_USUARIOS_INST"',0,2000);
get_source_uoid            CONSTANT VARCHAR2(2000) := SUBSTRB('043B5FA4CC2541AAE053B200090A2A1E',0,2000);
get_step_number            CONSTANT NUMBER(22) := 1;
...
"EXT_MP_USUARIOS_INST_si$1" NUMBER(22) := 0;

"EXT_MP_USUARIOS_INST_i$1" NUMBER(22) := 0;
...
TYPE "T_ROWKEY_EXT_MP_USUARIOS_IN$1" IS TABLE OF VARCHAR2(18) INDEX BY BINARY_INTEGER;
TYPE "T_EXT_MP_U_2_FECHA_LO$1" IS TABLE OF NUMBER(12) INDEX BY BINARY_INTEGER;
...
TYPE "T_STG_MP_U_1_COD_FECH$1" IS TABLE OF NUMBER(12) INDEX BY BINARY_INTEGER;
TYPE "T_STG_MP_U_2_COD_FECH$1" IS TABLE OF NUMBER(8) INDEX BY BINARY_INTEGER;
TYPE "T_STG_MP_U_3_COD_FECH$1" IS TABLE OF NUMBER(8) INDEX BY BINARY_INTEGER;

-- Bulk: intermediate scalar variables
"SV_EXT_MP_U_1_ID_CLIEN$1"  NUMBER(10);
"SV_ROWKEY_EXT_MP_USUARIOS_IN$1"  VARCHAR2(18);
"SV_EXT_MP_U_2_FECHA_LO$1"  NUMBER(12);
"SV_ROWKEY_DUMMY_TABLE_CURSOR"  VARCHAR2(18);
"SV_STG_MP_U_0_ID_CLIEN$1"  NUMBER(10);
"SV_STG_MP_U_1_COD_FECH$1"  NUMBER(12);
"SV_STG_MP_U_2_COD_FECH$1"  NUMBER(8);
"SV_STG_MP_U_3_COD_FECH$1"  NUMBER(8);

-- Bulk: intermediate collection variables
"EXT_MP_U_1_ID_CLIEN$1" "T_EXT_MP_U_1_ID_CLIEN$1";
"ROWKEY_EXT_MP_USUARIOS_INST$1" "T_ROWKEY_EXT_MP_USUARIOS_IN$1";
"EXT_MP_U_2_FECHA_LO$1" "T_EXT_MP_U_2_FECHA_LO$1";
"ROWKEY_DUMMY_TABLE_CURSOR" "T_ROWKEY_DUMMY_TABLE_CURSOR";
"STG_MP_U_0_ID_CLIEN$1" "T_STG_MP_U_0_ID_CLIEN$1";
"STG_MP_U_1_COD_FECH$1" "T_STG_MP_U_1_COD_FECH$1";
"STG_MP_U_2_COD_FECH$1" "T_STG_MP_U_2_COD_FECH$1";
...
--    RTE_ROWKEY, uniquely identifies a source row within and audited run
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_ES$1"(error_index IN NUMBER) IS
BEGIN
  ...
  OWBSYS.WB_RT_MAPAUDIT.error_source(
    ...
    p_table=>SUBSTR('"EXT_MP_USUARIOS_INST"',0,80),
    p_column=>SUBSTR('FECHA_LOGIN',0,80),
    p_value=>SUBSTRB("EXT_MP_U_2_FECHA_LO$1"(error_index),0,2000),
    p_step=>get_step_number,
    p_role=>'S'
    );
  RETURN;
    
  END "EXT_MP_USUARIOS_INST_ES$1";

---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_ER$1" registers error for one erroneous row
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_ER$1"(p_statement IN VARCHAR2, p_column IN VARCHAR2, p_col_value IN VARCHAR2, p_sqlcode IN NUMBER, p_sqlerrm IN VARCHAR2, p_auditd_id IN NUMBER, p_error_index IN NUMBER) IS
l_source_target_name VARCHAR2(80);
BEGIN
  IF p_auditd_id IS NULL THEN
    l_source_target_name := SUBSTR(get_source_name,0,80);
...
END IF;
  ...
  IF ( get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE ) AND (get_rowkey_error > 0) THEN
    "EXT_MP_USUARIOS_INST_ES$1"(p_error_index);
  END IF;
END "EXT_MP_USUARIOS_INST_ER$1";



---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_SU$1" opens and initializes data source
-- for map "EXT_MP_USUARIOS_INST_t"
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_SU$1" IS
BEGIN
  IF get_abort THEN
    RETURN;
  END IF;
  IF (NOT "EXT_MP_USUARIOS_INST_c$1"%ISOPEN) THEN
    OPEN "EXT_MP_USUARIOS_INST_c$1";
  END IF;
  get_read_success := TRUE;
END "EXT_MP_USUARIOS_INST_SU$1";

---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_RD$1" fetches a bulk of rows from
--   the data source for map "EXT_MP_USUARIOS_INST_t"
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_RD$1" IS
BEGIN
  IF NOT get_read_success THEN
    get_abort := TRUE;
    IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
  ...
  BEGIN
    ...
    "EXT_MP_U_2_FECHA_LO$1".DELETE;

    FETCH
      "EXT_MP_USUARIOS_INST_c$1"
    BULK COLLECT INTO
      "EXT_MP_U_1_ID_CLIEN$1",
      "EXT_MP_U_2_FECHA_LO$1"
    LIMIT get_bulk_size;

    get_total_processed_rowcount := get_total_processed_rowcount + "EXT_MP_U_1_ID_CLIEN$1".COUNT;

    IF "EXT_MP_USUARIOS_INST_c$1"%NOTFOUND AND "EXT_MP_U_1_ID_CLIEN$1".COUNT = 0 THEN
      RETURN;
    END IF;
    -- register feedback for successful reads
    IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
  ...
  last_error_message := SQLERRM;
      ...
      IF get_errors > get_max_errors THEN get_abort := TRUE; END IF;
  END;
END "EXT_MP_USUARIOS_INST_RD$1";

---------------------------------------------------------------------------
-- Procedure "EXT_MP_USUARIOS_INST_DML$1" does DML for a bulk of rows starting from index si.
---------------------------------------------------------------------------
PROCEDURE "EXT_MP_USUARIOS_INST_DML$1"(si NUMBER, firstround BOOLEAN) IS
 "STG_MP_USUARIOS_INST_ins0" NUMBER := "STG_MP_USUARIOS_INST_ins";
BEGIN
 IF get_use_hc THEN
  IF firstround AND NOT get_row_status THEN
...
AND (NOT (get_use_hc AND "STG_MP_USUARIOS_INST_nul")) THEN
  ...
  LOOP
    IF NOT get_use_hc THEN
    EXIT WHEN "STG_MP_USUARIOS_INST_i" <= get_bulk_size 
 AND "EXT_MP_USUARIOS_INST_c$1"%FOUND AND NOT get_abort;
    ELSE
      EXIT WHEN "STG_MP_USUARIOS_INST_si" >= "STG_MP_USUARIOS_INST_i";
    END IF;
    get_rowid.DELETE;
    ...
    BEGIN
      FORALL i IN "STG_MP_USUARIOS_INST_si".."STG_MP_USUARIOS_INST_i" - 1
        ...
        VALUES
          ...
          "STG_MP_U_1_COD_FECH$1"(i),
          "STG_MP_U_2_COD_FECH$1"(i),
  ...
  last_error_message := SQLERRM;
        ...
        IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
          ...
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."ID_CLIENTE"',0,80),SUBSTRB("STG_MP_U_0_ID_CLIEN$1"(error_index),0,2000));
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."COD_FECHA_LOGIN"',0,80),SUBSTRB("STG_MP_U_1_COD_FECH$1"(error_index),0,2000));
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"',0,80),SUBSTRB("STG_MP_U_2_COD_FECH$1"(error_index),0,2000));
          Main_ES(get_step_number,error_rowkey,get_target_name,SUBSTRB('"STG_MP_USUARIOS_INST"."COD_FECHA"',0,80),SUBSTRB("STG_MP_U_3_COD_FECH$1"(error_index),0,2000));
...
END "EXT_MP_USUARIOS_INST_DML$1";

---------------------------------------------------------------------------
-- "EXT_MP_USUARIOS_INST_t" main
---------------------------------------------------------------------------
...
END IF;
  ...
  IF NOT "STG_MP_USUARIOS_INST_St" THEN
    ...
    -- For table function (parallel row mode) operation, the cursor will already be
    -- open when the procedure is called, so execute the initialization.
    IF get_table_function OR (NOT "EXT_MP_USUARIOS_INST_c$1"%ISOPEN) THEN
      IF NOT (get_audit_level = AUDIT_NONE) THEN
        IF NOT "STG_MP_USUARIOS_INST_St" THEN
          "STG_MP_USUARIOS_INST_id" :=
            OWBSYS.WB_RT_MAPAUDIT.auditd_begin(  -- Template AuditDetailBegin
...
END IF;
    ...
    -- Initialize internal loop index variables
    "EXT_MP_USUARIOS_INST_si$1" := 0;
    "STG_MP_USUARIOS_INST_i" := 1;
    get_rows_processed := FALSE;

    IF NOT get_abort AND NOT get_abort_procedure THEN
      "EXT_MP_USUARIOS_INST_SU$1";

      LOOP
        IF "EXT_MP_USUARIOS_INST_si$1" = 0 THEN
          "EXT_MP_USUARIOS_INST_RD$1";   -- Fetch data from source
          IF NOT get_read_success THEN
...
"STG_MP_USUARIOS_INST_i" := 1;
        ...
        -- Processing:
        "EXT_MP_USUARIOS_INST_i$1" := "EXT_MP_USUARIOS_INST_si$1";
        BEGIN
          
          LOOP
            EXIT WHEN "STG_MP_USUARIOS_INST_i" > get_bulk_size OR get_abort OR get_abort_procedure;

            "EXT_MP_USUARIOS_INST_i$1" := "EXT_MP_USUARIOS_INST_i$1" + 1;
            "EXT_MP_USUARIOS_INST_si$1" := "EXT_MP_USUARIOS_INST_i$1";
            IF get_use_hc THEN
              get_row_status := TRUE;
                "STG_MP_USUARIOS_INST_new" := FALSE;
            END IF;
            ...
            get_buffer_done(get_buffer_done_index) := 
              ("EXT_MP_USUARIOS_INST_c$1"%NOTFOUND AND
               "EXT_MP_USUARIOS_INST_i$1" > bulk_count);

            IF (NOT get_buffer_done(get_buffer_done_index)) AND
              "EXT_MP_USUARIOS_INST_i$1" > bulk_count THEN
...
get_target_name := '"STG_MP_USUARIOS_INST"';
            ...
            IF NOT "STG_MP_USUARIOS_INST_St" AND NOT get_buffer_done(get_buffer_done_index) THEN
              BEGIN
                get_rows_processed := true; -- Set to indicate that some row data was processed (for debugger)
            		error_stmt := SUBSTRB('"STG_MP_U_0_ID_CLIEN$1"("STG_MP_USUARIOS_INST_i") := 
            
            "EXT_MP_U_1_ID_CLIEN$1"("EXT_MP_USUARIOS_INST_i$1");',0,2000);
            error_column := SUBSTRB('"STG_MP_U_0_ID_CLIEN$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("EXT_MP_U_1_ID_CLIEN$1"("EXT_MP_USUARIOS_INST_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_0_ID_CLIEN$1"("STG_MP_USUARIOS_INST_i") :=
            
            "EXT_MP_U_1_ID_CLIEN$1"("EXT_MP_USUARIOS_INST_i$1");
            ...
            END IF;
            		...
            		error_stmt := SUBSTRB('"STG_MP_U_1_COD_FECH$1"("STG_MP_USUARIOS_INST_i") := 
            
            "EXT_MP_U_2_FECHA_LO$1"("EXT_MP_USUARIOS_INST_i$1");',0,2000);
            error_column := SUBSTRB('"STG_MP_U_1_COD_FECH$1"',0,80);
            
            BEGIN
              error_value := SUBSTRB("EXT_MP_U_2_FECHA_LO$1"("EXT_MP_USUARIOS_INST_i$1"),0,2000);
            EXCEPTION 
              WHEN OTHERS THEN
                error_value := '*';
            END;
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_1_COD_FECH$1"("STG_MP_USUARIOS_INST_i") :=
            
            "EXT_MP_U_2_FECHA_LO$1"("EXT_MP_USUARIOS_INST_i$1");
            
            ELSIF get_row_status THEN
              "SV_STG_MP_U_1_COD_FECH$1" :=
            ...
            END IF;
            		...
            		error_stmt := SUBSTRB('"STG_MP_U_2_COD_FECH$1"("STG_MP_USUARIOS_INST_i") := 
            
            "APP_STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"/* ATTRIBUTE P_COD_FECHA_DIARIO.OUTGRP1.COD_FECHA_DIARIO */;',0,2000);
            error_column := SUBSTRB('"STG_MP_U_2_COD_FECH$1"',0,80);
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_2_COD_FECH$1"("STG_MP_USUARIOS_INST_i") :=
            
            "APP_STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO"/* ATTRIBUTE P_COD_FECHA_DIARIO.OUTGRP1.COD_FECHA_DIARIO */;
            
            ELSIF get_row_status THEN
              "SV_STG_MP_U_2_COD_FECH$1" :=
            ...
            END IF;
            		...
            		error_stmt := SUBSTRB('"STG_MP_U_3_COD_FECH$1"("STG_MP_USUARIOS_INST_i") := 
            ...
            IF NOT get_use_hc THEN
              "STG_MP_U_3_COD_FECH$1"("STG_MP_USUARIOS_INST_i") :=
            ...
            END IF;
                ...
                IF get_audit_level = AUDIT_ERROR_DETAILS OR get_audit_level = AUDIT_COMPLETE THEN
                  IF NOT get_use_hc THEN
                    "STG_MP_USUARIOS_INST_srk"("STG_MP_USUARIOS_INST_i") := get_rowkey + "EXT_MP_USUARIOS_INST_i$1" - 1;
                  ELSIF get_row_status THEN
                    "SV_STG_MP_USUARIOS_INST_srk" := get_rowkey + "EXT_MP_USUARIOS_INST_i$1" - 1;
                  ELSE
                    NULL;
                  END IF;
                  END IF;
  ...
  last_error_message := SQLERRM;
                  ...
                  "EXT_MP_USUARIOS_INST_ER$1"('TRACE 29: ' || error_stmt, error_column, error_value, SQLCODE, SQLERRM, get_audit_detail_id, "EXT_MP_USUARIOS_INST_i$1");
            ...
            AND (NOT "STG_MP_USUARIOS_INST_nul") THEN
              "STG_MP_USUARIOS_INST_ir"(dml_bsize) := "STG_MP_USUARIOS_INST_i";
            	"STG_MP_U_0_ID_CLIEN$1"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_0_ID_CLIEN$1";
            	"STG_MP_U_1_COD_FECH$1"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_1_COD_FECH$1";
            	"STG_MP_U_2_COD_FECH$1"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_2_COD_FECH$1";
            	"STG_MP_U_3_COD_FECH$1"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_U_3_COD_FECH$1";
              "STG_MP_USUARIOS_INST_srk"("STG_MP_USUARIOS_INST_i") := "SV_STG_MP_USUARIOS_INST_srk";
              "STG_MP_USUARIOS_INST_i" := "STG_MP_USUARIOS_INST_i" + 1;
            ELSE
              "STG_MP_USUARIOS_INST_ir"(dml_bsize) := 0;
          ...
          "EXT_MP_USUARIOS_INST_DML$1"(1, TRUE);
          IF get_use_hc THEN
            IF NOT get_row_status THEN
              FOR start_index IN 1..dml_bsize LOOP
                "EXT_MP_USUARIOS_INST_DML$1"(start_index, FALSE);
              END LOOP;
            ELSE
              COMMIT;
            END IF;
        ...
        EXCEPTION
          WHEN OTHERS THEN
              last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
            "EXT_MP_USUARIOS_INST_ER$1"('TRACE 26: ' || error_stmt, '*', NULL, SQLCODE, SQLERRM, NULL, "EXT_MP_USUARIOS_INST_i$1");
            get_errors := get_errors + 1;
            IF get_errors > get_max_errors THEN  
  get_abort := TRUE;
END IF;
  ...
  IF NOT "STG_MP_USUARIOS_INST_St" AND bulk_commit_count > get_commit_frequency THEN
        ...
        cursor_exhausted := "EXT_MP_USUARIOS_INST_c$1"%NOTFOUND;
        exit_loop_normal := get_abort OR get_abort_procedure OR (cursor_exhausted AND "EXT_MP_USUARIOS_INST_i$1" > bulk_count);
        exit_loop_early := get_rows_processed AND get_bulk_loop_count IS NOT NULL AND "EXT_MP_USUARIOS_INST_i$1" >= get_bulk_loop_count;
        get_close_cursor := get_abort OR get_abort_procedure OR cursor_exhausted;
        EXIT WHEN exit_loop_normal OR exit_loop_early;
    ...
    BEGIN
      IF get_close_cursor THEN
        CLOSE "EXT_MP_USUARIOS_INST_c$1";
      END IF;
    EXCEPTION WHEN OTHERS THEN
      NULL;
      END;
...
PROCEDURE Initialize("COD_FECHA" IN NUMBER
 DEFAULT NULL,
"CANT_FILAS" IN NUMBER
 DEFAULT NULL,
"COD_FECHA_DIARIO" IN NUMBER
...
"APP_STG_MP_USUARIOS_INST"."COD_FECHA" := "APP_STG_MP_USUARIOS_INST".Initialize."COD_FECHA";
"APP_STG_MP_USUARIOS_INST"."CANT_FILAS" := "APP_STG_MP_USUARIOS_INST".Initialize."CANT_FILAS";
"APP_STG_MP_USUARIOS_INST"."COD_FECHA_DIARIO" := "APP_STG_MP_USUARIOS_INST".Initialize."COD_FECHA_DIARIO";
"APP_STG_MP_USUARIOS_INST"."TABLE_NAME" := "APP_STG_MP_USUARIOS_INST".Initialize."TABLE_NAME";
  ...
  IF NOT (get_audit_level = AUDIT_NONE) THEN
    get_runtime_audit_id := OWBSYS.WB_RT_MAPAUDIT.audit_begin(  -- Template AuditBegin
      ...
      p_parent=>NULL,
      p_source=>'"EXT_MP_USUARIOS_INST"',
      p_source_uoid=>'043B5FA4CC2541AAE053B200090A2A1E',
      p_target=>'"STG_MP_USUARIOS_INST"',
      p_target_uoid=>'043B5FA4CC1041AAE053B200090A2A1E',      p_info=>NULL,
...
BEGIN
  ...
  "PACK_STG_UTILS"."FN_TRAILER_CHECK"(("APP_STG_MP_USUARIOS_INST"."TABLE_NAME"/* ATTRIBUTE P_TABLE_NAME.OUTGRP1.TABLE_NAME */),("APP_STG_MP_USUARIOS_INST"."CANT_FILAS"/* ATTRIBUTE P_CANT_FILAS.OUTGRP1.CANT_FILAS */))/* OPERATOR FN_TRAILER_CHECK */;
...
EXCEPTION
  WHEN OTHERS THEN
      last_error_number  := SQLCODE;
  last_error_message := SQLERRM;
    "STG_MP_USUARIOS_IN_tt_sqlcode" := SQLCODE;
    "STG_MP_USUARIOS_IN_tt_sqlerrm" := SQLERRM;
END;
...
PROCEDURE Finalize("COD_FECHA" IN NUMBER
 DEFAULT NULL,
"CANT_FILAS" IN NUMBER
 DEFAULT NULL,
"COD_FECHA_DIARIO" IN NUMBER
...
BEGIN
  ...
  END IF;
        ...
        AND    uo.object_name = 'APP_STG_MP_USUARIOS_INST'
        AND    uo.object_id = ao.object_id;
 
        OWBSYS.wb_rt_mapaudit_util.set_schema_workspace(x_schema);
    
  Initialize("COD_FECHA", "CANT_FILAS", "COD_FECHA_DIARIO", "TABLE_NAME", 
  p_env);
  ...
  END IF;
   ...
   IF get_operating_mode = MODE_SET THEN
    ...
    IF NOT get_use_hc OR get_batch_status THEN
        "STG_MP_USUARIOS_INST_St" := "STG_MP_USUARIOS_INST_Bat"("COD_FECHA", "CANT_FILAS", "COD_FECHA_DIARIO", "TABLE_NAME");
        get_batch_status := get_batch_status AND "STG_MP_USUARIOS_INST_St";
      END IF;
   ...
   "EXT_MP_USUARIOS_INST_p"("COD_FECHA", "CANT_FILAS", "COD_FECHA_DIARIO", "TABLE_NAME");
   END IF;
  ...
  "EXT_MP_USUARIOS_INST_t"("COD_FECHA", "CANT_FILAS", "COD_FECHA_DIARIO", "TABLE_NAME");
  ...
  END IF;
   ...
   Finalize("COD_FECHA", "CANT_FILAS", "COD_FECHA_DIARIO", "TABLE_NAME", 
  p_env);
...
BEGIN
  ...
  IF get_job_audit THEN 
     OWBSYS.wb_rt_mapaudit_util.premap('APP_STG_MP_USUARIOS_INST', x_schema, x_audit_id, x_object_id);
  ELSE
    OWBSYS.wb_rt_mapaudit_util.set_schema_workspace(x_schema);
  END IF;
...
-- OWBSYS.wb_rt_mapaudit_util.register_custom_param(x_audit_id,
  ...
  x_return_code := NULL;
  BEGIN
      x_result := Main( "COD_FECHA", "CANT_FILAS", "COD_FECHA_DIARIO", "TABLE_NAME",
      x_env);
  EXCEPTION
    WHEN OTHERS THEN
      x_result := 1;
...
BEGIN
BEGIN
  IF "EXT_MP_USUARIOS_INST_c"%ISOPEN THEN
    CLOSE "EXT_MP_USUARIOS_INST_c";
  END IF;
EXCEPTION
  WHEN OTHERS THEN
    NULL;    
END;BEGIN
  IF "EXT_MP_USUARIOS_INST_c$1"%ISOPEN THEN
    CLOSE "EXT_MP_USUARIOS_INST_c$1";
  END IF;
EXCEPTION
  WHEN OTHERS THEN
